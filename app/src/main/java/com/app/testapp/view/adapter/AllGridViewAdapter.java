 ...
 */
public class AllGridViewAdapter extends RecyclerView.Adapter<AllGridViewAdapter.MyViewHolder> {
    private Context mContext;
    private List<CategoryDataModel> mData;

    public AllGridViewAdapter(Context context, List<CategoryDataModel> data) {
        mContext = context;
        mData = data;
    }
