 ...
 */
public class MenGridViewAdapter extends RecyclerView.Adapter<MenGridViewAdapter.MyViewHolder> {
    private Context mContext;
    private List<CategoryDataModel> mData;

    public MenGridViewAdapter(Context context, List<CategoryDataModel> data) {
        mContext = context;
        mData = data;
    }
