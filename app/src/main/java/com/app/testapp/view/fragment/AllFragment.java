...
import com.app.testapp.view.adapter.AllGridViewAdapter;
...
public class AllFragment extends Fragment implements AllGridViewAdapter.ClickListener {
    private static final String TAG = "AllFragment";
    private Context mContext;

    private Unbinder mUnbinder;
    private List<CategoryDataModel> mDataArray = new ArrayList<>();
    private AllGridViewAdapter mGridViewAdapter;
    ...
    public AllFragment(String data) {
        mDataUrl = data;
    }
    ...
    private void init() {
        mGridViewAdapter = new AllGridViewAdapter(mContext, mDataArray);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(mContext, 2);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mRecyclerView.addOnItemTouchListener(new AllGridViewAdapter.RecyclerTouchListener(mContext, mRecyclerView, this));
