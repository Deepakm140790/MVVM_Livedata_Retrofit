...
import com.app.testapp.view.adapter.WomenGridViewAdapter;
...
public class WomenFragment extends Fragment implements WomenGridViewAdapter.ClickListener {
    ...
    private WomenGridViewAdapter mGridViewAdapter;

    @BindView(R.id.pb_women)
    ProgressBar mProgressBar;
    @BindView(R.id.rv_women)
    RecyclerView mRecyclerView;

    public WomenFragment(String data) {
        mDataUrl = data;
    }
    ...
    private void init() {
        mGridViewAdapter = new WomenGridViewAdapter(mContext, mDataArray);
        RecyclerView.LayoutManager mLayoutManager = new GridLayoutManager(mContext, 2);
        mRecyclerView.setLayoutManager(mLayoutManager);
        mRecyclerView.setItemAnimator(new DefaultItemAnimator());
        mRecyclerView.addOnItemTouchListener(new WomenGridViewAdapter.RecyclerTouchListener(mContext, mRecyclerView, this));
